...
Article.create!(title: "Yet another Spirit Airlines flight turns back over awful odor: 'Like wet socks'", author: "Michael Bartiromo", source: "Fox News", summary: "Yet another Spirit Airlines flight was forced to change plans due to an unknown odor in the cabin.", content: "Yet another Spirit Airlines flight was forced to change plans due to an unknown odor in the cabin.@@
